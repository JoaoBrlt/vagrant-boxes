...
variable "iso_checksum" {
  type        = string
  default     = "sha256:487f87faaf547ea30e0aba4d5b53346292571256b25333a978db1692bcee9dd2"
...
source "qemu" "vm" {
  ...
  accelerator      = "kvm"
  headless         = true
  output_directory = "builds/ubuntu-desktop-26.04-amd64-qemu"
...
build {
  ...
  post-processors {
    ...
    post-processor "vagrant" {
      compression_level = 9
      output            = "builds/ubuntu-desktop-26.04-amd64-{{.Provider}}.box"
    }
    ...
    post-processor "vagrant-registry" {
      ...
      box_tag       = "joaobrlt/ubuntu-desktop-26.04"
      version       = "${var.version}"
      architecture  = "amd64"
    }
  }
